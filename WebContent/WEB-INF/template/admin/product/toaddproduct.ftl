...
<div class="form-group ">
    ...
    <div class="col-sm-4">
        <input type="text" id="title" name="title" class="col-xs-12 col-sm-12" value="">
        <span class="errorClass"></span>
    	<input type="hidden" name="materials" value='${(materialName)!''}'>
    	<input type="hidden" name="codeQuality" value="${codeQuality}">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" id="author" name="author" class="col-xs-12 col-sm-12" value="">
        <span class="errorClass"></span>
    </div>
</div>
...
<div class="form-group ">
    ...
    <div class="col-sm-4">
        <input type="text" id="mobile" name="mobile" class="col-xs-12 col-sm-12" value="">
        <span class="errorClass"></span>
    </div>
</div>
...
<div class="form-group ">
    ...
    <div class="col-sm-4">
        <select class="col-xs-12 col-sm-12" name="type">
        	...
        	<#list types as type>
            <option value="${type.cateName}">${type.cateName}</option>
            </#list>
            </#if>
        </select>
    </div>
...
<div class="form-group">
                                  ...
                                  <div class="col-sm-4">
                                        ...
                                        <img id="first_img" src="11" width="80" >
                                      </a>
                                       <input type="file" name="more1" id="file_upload_0" class="col-xs-12 col-sm-6"/>
                                  </div>
                                </div>
<div class="space-4"></div>
        ...
        <img width="100px" height="100px" src="">
							...
							<div class="form-group">
                                  ...
                                  <div class="col-xs-12 col-sm-6" id="J_duotu">
                                    ...
                                    <div id="img_list">
                                    	<img src="1" width="100" height="100" style="display:none">
                                    ...
                                    <script type="text/javascript">
                                    	function clean(){
                                    		$("#img_list > img").attr("src","").css("display","none");
                                    		$("#img_list > input[type='file']").val("").hide().eq(0).show();
                                    	}
                                    </script>
                                  </div>
                                </div>
                    ...
                    <div class="table-responsive">
                        <div class="dataTables_wrapper">
                            <table id="J_Table" class="table table-striped table-bordered table-hover J_Table" >
                                ...
                                <input type="hidden" name="unitQuality" value="${material.unitQuality}">
                                <th><input type="text" name="more2"></th>
                                </tr>
                                </#list>
                                </#if>
                                </tbody>
...
<div class="clearfix">
    <div class="col-sm-offset-1 col-sm-10">
        <button class="btn btn-info" type="button" onclick="toCheck('${request.contextPath}/admin/product/checkQuality','${request.contextPath}/admin/productInfo/list/p1');">
...
function toCheck(checkurl,tourl) {
	...
	if(!(/^1[3|4|5|8|7][0-9]\d{4,8}$/.test(mobile)) || mobile.length!=11){ 
        alert("手机号码格式不正确"); 
        return; 
    }
